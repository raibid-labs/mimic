...
This document catalogs existing testing solutions and approaches for Ratatui TUI applications, analyzing their strengths, limitations, and how `term-test` fits into the ecosystem.
...
| **term-test** (proposed) | Integration | ✅ | ✅ Sixel | ✅ | ✅ | ✅ |
...
## How term-test Fits In

### Complementary, Not Competitive

`term-test` **complements** existing solutions:
...
What `term-test` provides that nothing else does:
...
Components from existing solutions that term-test can leverage:
...
1. **Testing is currently hard** ✅ term-test addresses this
2. **TestBackend not user-friendly** ✅ term-test provides better API
3. **Need for integration testing** ✅ term-test's core purpose
4. **Graphics testing missing** ✅ term-test includes Sixel support
