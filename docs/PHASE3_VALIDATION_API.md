...
This document specifies the validation APIs for Sixel graphics testing in term-test. These APIs enable developers to verify that Sixel graphics appear in the correct locations and stay within designated bounds.
